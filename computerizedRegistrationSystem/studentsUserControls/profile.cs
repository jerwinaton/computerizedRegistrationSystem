    ...
    public partial class profile : UserControl
    {
                    ...
                    try
                    {
                        ...
                        command.CommandText = "UPDATE applicantsTable SET first_name='" + textBoxFName.Text.ToUpper() + "',middle_name='" + textBoxMName.Text.ToUpper() + "'," +
                            ...
                            "street='" + textBoxStreet.Text.ToUpper() + "',district='" + comboBoxDistrict.Text + "'," +
                                         ...
                                         "status='FOLLOW UP',track='" + comboBoxTrack.Text + "',strand='" + comboBoxStrand.Text +"'"+
                                         " WHERE applicant_id=" + frmLogin.id; // where the applicant_id = to the id the user that logged in (in the login.cs);
        ...
        private void profile_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                command.CommandText = "SELECT * FROM studentsTable WHERE student_id=" + frmLogin.id; // where the applicant_id = to the id the user that logged in (in the login.cs)
